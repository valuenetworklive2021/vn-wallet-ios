...
public struct Constants {
    public static let keychainKeyPrefix = "vnwallet"
    public static let xdaiDropPrefix = Data(bytes:
        [0x58, 0x44, 0x41, 0x49, 0x44, 0x52, 0x4F, 0x50]
    ).hex()

    public static let mainnetMagicLinkHost = "vnw.app"
    public static let legacyMagicLinkHost = "valuenetwork.live"
    public static let classicMagicLinkHost = "classic.vnw.app"
    public static let callistoMagicLinkHost = "callisto.vnw.app"
    public static let kovanMagicLinkHost = "kovan.vnw.app"
    public static let ropstenMagicLinkHost = "ropsten.vnw.app"
    public static let rinkebyMagicLinkHost = "rinkeby.vnw.app"
    public static let poaMagicLinkHost = "poa.vnw.app"
    public static let sokolMagicLinkHost = "sokol.vnw.app"
    public static let xDaiMagicLinkHost = "xdai.vnw.app"
    public static let goerliMagicLinkHost = "goerli.vnw.app"
    public static let artisSigma1MagicLinkHost = "artis_sigma1.vnw.app"
    public static let artisTau1MagicLinkHost = "artis_tau1.vnw.app"
    public static let binanceMagicLinkHost = "binance.vnw.app"
    public static let binanceTestMagicLinkHost = "test-binance.vnw.app"
    public static let hecoMagicLinkHost = "heco.vnw.app"
    public static let hecoTestMagicLinkHost = "test-heco.vnw.app"
    public static let customMagicLinkHost = "custom.vnw.app"
    public static let fantomMagicLinkHost = "fantom.vnw.app"
    public static let fantomTestMagicLinkHost = "test-fantom.vnw.app"
    public static let avalancheMagicLinkHost = "avalanche.vnw.app"
    public static let avalancheTestMagicLinkHost = "test-avalanche.vnw.app"
    public static let maticMagicLinkHost = "polygon.vnw.app"
    public static let mumbaiTestMagicLinkHost = "test-polygon.vnw.app"
    public static let optimisticMagicLinkHost = "optimistic.vnw.app"
    public static let optimisticTestMagicLinkHost = "optimistic-kovan.vnw.app"
    public static let cronosTestMagicLinkHost = "test-cronos.vnw.app"
    public static let arbitrumMagicLinkHost = "arbitrum.vnw.app"
    public static let palmMagicLinkHost = "palm.vnw.app"
    public static let palmTestnetMagicLinkHost = "palmTestnet.vnw.app"

    public enum Currency {
        static let usd = "USD"
    }
    // Magic link networks
    public static let legacyMagicLinkPrefix = "https://valuenetwork.live/"
    ...
    // social
    public static let website = "https://valuenetwork.live/"
    public static let twitterUsername = "vntwdefi"
    public static let redditGroupName = "r/AlphaWallet/"
    public static let facebookUsername = "valuenetworklive"

    // support
    public static let supportEmail = "feedback+ios@valuenetwork.live"
    public static let dappsBrowserURL = "http://vnw.app"
    ...
    static let buyXDaiWitRampUrl = "https://buy.ramp.network/?hostApiKey=\(Constants.Credentials.rampApiKey)&hostLogoUrl=https%3A%2F%2Fvaluenetwork.live%2Ffavicon.png&hostAppName=VNWallet&swapAsset=xDai"

    static func buyWitRampUrl(asset: String) -> String {
        "https://buy.ramp.network/?hostApiKey=\(Constants.Credentials.rampApiKey)&hostLogoUrl=https%3A%2F%2Fvaluenetwork.live%2Ffavicon.png&hostAppName=VNWallet&swapAsset=\(asset)"
    }
    ...
    static let defaultEnabledServers: [RPCServer] = [.main, .binance_smart_chain]
    static let defaultEnabledTestnetServers: [RPCServer] = [.rinkeby, .binance_smart_chain_testnet]

    static let tokenScriptUrlSchemeForResources = "tokenscript-resource:///"

    //validator API
    static let tokenScriptValidatorAPI = "https://vnw.app/api/v1/verifyXMLDSig"

    static let launchShortcutKey = "live.valuenetwork.alphawallet.qrScanner"
